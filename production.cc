...
char *ProductionB::get_outstr() { return outStr; }
...
void ProductionB::setMerges(char c) { merge_cen = c; }
...
ProductionH::ProductionH(int s, int a, int b) : ProductionB(s, a, b) {}

ProductionH::ProductionH(int s, int a, int b, float pr, char *out)
    : ProductionB(s, a, b, pr, out) {}

void ProductionH::print() { printf("%d -> %d : %d\n", S, A, B); }

char ProductionH::tipo() { return 'H'; }
...
void ProductionH::print_mathml(Grammar *G, Hypothesis *H, FILE *fout,
  ...
  if (!H->hi->pt && H->hi->prod->tipo() == 'P' && !H->hi->hi->pt &&
    ...
    // Deal with a bracketed expression such that only the right parenthesis has
    // a superscript  this is because CROHME evaluation requires this
    // representation... in a non-ambiguous  evaluation escenario this must be
    // removed

    Hypothesis *hip = H->hi->hi;
    while (hip->prod && hip->hd->prod && hip->hd->hd->prod) hip = hip->hd;
...
ProductionV::ProductionV(int s, int a, int b) : ProductionB(s, a, b) {}

ProductionV::ProductionV(int s, int a, int b, float pr, char *out)
    : ProductionB(s, a, b, pr, out) {}

void ProductionV::print() { printf("%d -> %d / %d\n", S, A, B); }

char ProductionV::tipo() { return 'V'; }
...
void ProductionV::print_mathml(Grammar *G, Hypothesis *H, FILE *fout,
  ...
  if (hdhiclass && (!strcmp(hdhiclass, "\\sum") ||
                    !strcmp(hdhiclass, "\\int") || !strcmp(hdhiclass, "-"))) {
...
ProductionVe::ProductionVe(int s, int a, int b) : ProductionB(s, a, b) {}

ProductionVe::ProductionVe(int s, int a, int b, float pr, char *out)
    : ProductionB(s, a, b, pr, out) {}

void ProductionVe::print() { printf("%d -> %d /e %d\n", S, A, B); }

char ProductionVe::tipo() { return 'e'; }
...
ProductionSSE::ProductionSSE(int s, int a, int b) : ProductionB(s, a, b) {}

ProductionSSE::ProductionSSE(int s, int a, int b, float pr, char *out)
    : ProductionB(s, a, b, pr, out) {}

void ProductionSSE::print() { printf("%d -> %d sse %d\n", S, A, B); }

char ProductionSSE::tipo() { return 'S'; }
...
ProductionSup::ProductionSup(int s, int a, int b) : ProductionB(s, a, b) {}

ProductionSup::ProductionSup(int s, int a, int b, float pr, char *out)
    : ProductionB(s, a, b, pr, out) {}

void ProductionSup::print() { printf("%d -> %d ^ %d\n", S, A, B); }

char ProductionSup::tipo() { return 'P'; }
...
void ProductionSup::print_mathml(Grammar *G, Hypothesis *H, FILE *fout,
  ...
  if (!H->hi->pt && !H->hi->hi->prod &&
    ...
    Hypothesis *hip = H->hi;
    while (!hip->pt && !hip->hd->pt && !hip->hd->hd->pt) hip = hip->hd;
...
ProductionSub::ProductionSub(int s, int a, int b) : ProductionB(s, a, b) {}

ProductionSub::ProductionSub(int s, int a, int b, float pr, char *out)
    : ProductionB(s, a, b, pr, out) {}

void ProductionSub::print() { printf("%d -> %d _ %d\n", S, A, B); }

char ProductionSub::tipo() { return 'B'; }
...
ProductionIns::ProductionIns(int s, int a, int b) : ProductionB(s, a, b) {}

ProductionIns::ProductionIns(int s, int a, int b, float pr, char *out)
    : ProductionB(s, a, b, pr, out) {}

void ProductionIns::print() { printf("%d -> %d /e %d\n", S, A, B); }

char ProductionIns::tipo() { return 'I'; }
...
ProductionMrt::ProductionMrt(int s, int a, int b) : ProductionB(s, a, b) {}

ProductionMrt::ProductionMrt(int s, int a, int b, float pr, char *out)
    : ProductionB(s, a, b, pr, out) {}

void ProductionMrt::print() { printf("%d -> %d /m %d\n", S, A, B); }

char ProductionMrt::tipo() { return 'M'; }
...
bool ProductionT::getClase(int k) { return clases[k]; }

char *ProductionT::getTeX(int k) { return texStr[k]; }

char ProductionT::getMLtype(int k) { return mltype[k]; }

float ProductionT::getPrior(int k) { return probs[k]; }

int ProductionT::getNoTerm() { return S; }
